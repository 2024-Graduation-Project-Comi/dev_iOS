...
struct ModelDetailView: View {
    ...
    private func goCallViewButton() -> some View {
        Button {
            ...
            .background(
            NavigationLink(
                destination: CallingView(gotoRoot: $gotoRoot, topicTitle: selected?.koTitle ?? "", model: self.model, callId: nil)
...
#Preview {
    ModelDetailView(gotoRoot: .constant(true), model: RealmModel.init())
}
